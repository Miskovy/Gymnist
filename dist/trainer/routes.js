...
const trainerController = __importStar(require("./controller"));
const validator = __importStar(require("./validator"));
const hasPrivilage_1 = require("../middlewares/hasPrivilage");
const verifyToken_1 = __importDefault(require("../middlewares/verifyToken"));
const router = express_1.default.Router();
router.use(verifyToken_1.default);
router.get('/', (0, hasPrivilage_1.hasPrivilege)('Trainer', 'View'), trainerController.getAllTrainers);
router.get('/:id', validator.validateTrainerId, validator.handleValidationErrors, trainerController.getTrainerById);
router.post('/', (0, hasPrivilage_1.hasPrivilege)('Trainer', 'Create'), validator.validateTrainerCreation, validator.handleValidationErrors, trainerController.createTrainer);
